...
const InlineText = (props: Props) => {
  ...
  return (
    ...
    style={{ transform: `translateX(${translateXValue}px)` }}><span className='text-black text-edge-outline'>ACTIF NUMERIQUE</span> / SMART CONTRACT / <span className='text-black text-edge-outline'>NFT</span>  /FRONT END  / <span className='text-black text-edge-outline'>IOS</span> / MARKETPLACE / <span className='text-black text-edge-outline'>APP DECENTRALISEE</span> / ACTIF NUMERIQUE </h3>
  )
}
