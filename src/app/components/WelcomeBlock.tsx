  ...
  return (
    <div className='relative flex flex-col gap-10 items-center px-4 py-10 pt-0 w-full min-h-screen'>
        ...
        <div className='flex flex-col gap-10 justify-between items-center min-h-screen p-10 text-white'>
            ...
            <div className="relative w-full md:w-1/2 -translate-y-20 md:-translate-y-36 ">
            ...
            <h2 className='text-neutral-400 w-3/4 md:w-2/3 text-center animate-fade-in'>Construisez les futurs usages numériques avec les technologies du web3, de la blockchain et des applications mobiles</h2>
