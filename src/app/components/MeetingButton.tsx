...
const MeetingButton = (props: Props) => {
  ...
  return (
    <>
        <button className='px-8 py-2 my-10 rounded-full bg-cyan-500  text-white  text-2xl hover:bg-cyan-800 hover:font-light transition-all duration-200' onClick={toggleCalendly}>Prendre un rdv</button>
        <PopupModal
