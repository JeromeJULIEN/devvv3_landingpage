...
const OfferStarter = (props: Props) => {
    ...
    return (
        <div className='flex flex-col item-center gap-4 text-white md:w-1/3 border border-gray-500 rounded-lg p-4'>
            <h3 className='text-3xl'><strong>Starter kit : </strong>{t('starter.headline')}</h3>
            <h4 className='text-xl text-cyan-500 pb-6'>{t('starter.price1')}<strong>1000€ </strong>{t('starter.price2')}<strong> 2500€</strong></h4>
