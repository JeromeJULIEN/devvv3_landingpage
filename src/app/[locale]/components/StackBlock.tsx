...
const StackBlock = (props: Props) => {
  ...
  return (
    <div className='relative flex flex-col gap-10 items-center px-4 py-10 w-full min-h-screen'>
        ...
        <h3 className='text-white text-2xl pt-10 font-semibold text-center'><span className='text-cyan-500'>{locale ==="en" ? "WEB3 FRONT END" : "FRONT-END WEB3"}</span> / {t("decentralisedApp").toUpperCase()}</h3>
