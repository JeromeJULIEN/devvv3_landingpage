...
import profilPic2 from "../../../../public/profilPic2.png";
...
const CompanyBlock = (props: Props) => {
  ...
  return (
    <div className="flex flex-col gap-10 items-center px-4 pt-10 bg-white w-full min-h-screen">
      ...
      <div className="flex flex-col gap-4 justify-center items-center">
        <div className="flex gap-4 items-center">
          <Image
            ...
            quality={100}
            width={100}
            className="rounded-full w-30 sm:w-40"
          />
      ...
      <h2 className="text-3xl md:text-4xl font-semibold text-center mt-10 -mb-10">
        &lt; CONTACT /&gt;
      </h2>
      ...
      <div className="flex gap-10">
        <a
          href="mailto:jerome@devvv3.com?subject=Prise de contract depuis le site devvv3.com"
          target="_blank"
        >
